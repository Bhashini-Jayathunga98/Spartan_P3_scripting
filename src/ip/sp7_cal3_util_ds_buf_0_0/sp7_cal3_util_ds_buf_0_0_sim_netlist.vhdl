...
-- Date        : Tue Feb 11 14:40:52 2025
-- Host        : bhashini-laptop running 64-bit Ubuntu 18.04.1 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/bhashini/Desktop/spartan_p3_new/scripting/src/ip/sp7_cal3_util_ds_buf_0_0/sp7_cal3_util_ds_buf_0_0_sim_netlist.vhdl
-- Design      : sp7_cal3_util_ds_buf_0_0
...
entity sp7_cal3_util_ds_buf_0_0util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is "IBUFDS";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of sp7_cal3_util_ds_buf_0_0util_ds_buf : entity is "util_ds_buf";
end sp7_cal3_util_ds_buf_0_0util_ds_buf;

architecture STRUCTURE of sp7_cal3_util_ds_buf_0_0util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity sp7_cal3_util_ds_buf_0_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of sp7_cal3_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of sp7_cal3_util_ds_buf_0_0 : entity is "sp7_cal3_util_ds_buf_0_0,util_ds_buf,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of sp7_cal3_util_ds_buf_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of sp7_cal3_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2020.1";
end sp7_cal3_util_ds_buf_0_0;

architecture STRUCTURE of sp7_cal3_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 122880000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN sp7_cal3_AFE_VCXO_SP7_122M88_CLK_LVDS_N, INSERT_VIP 0";
begin
U0: entity work.sp7_cal3_util_ds_buf_0_0util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
