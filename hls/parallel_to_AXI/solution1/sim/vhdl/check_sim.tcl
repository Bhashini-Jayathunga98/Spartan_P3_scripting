...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.parallel_to_AXI.autotvin_gmem.dat"
         "c.parallel_to_AXI.autotvin_wdata.dat"
         "c.parallel_to_AXI.autotvin_wadd.dat"
         "c.parallel_to_AXI.autotvin_radd.dat"
         "c.parallel_to_AXI.autotvin_cmd.dat"
         "c.parallel_to_AXI.autotvin_AXI.dat"
         "c.parallel_to_AXI.autotvout_gmem.dat"
         "c.parallel_to_AXI.autotvout_rdata.dat"
         "c.parallel_to_AXI.autotvout_sta.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.parallel_to_AXI.autotvout_gmem.dat"
         "rtl.parallel_to_AXI.autotvout_rdata.dat"
         "rtl.parallel_to_AXI.autotvout_sta.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
