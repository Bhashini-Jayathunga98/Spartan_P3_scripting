...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("wdata", 32, hls_in, 1, "ap_none", "in_data", 1),
	Port_Property("wadd", 32, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("rdata", 32, hls_out, 3, "ap_ovld", "out_data", 1),
	Port_Property("rdata_ap_vld", 1, hls_out, 3, "ap_ovld", "out_vld", 1),
	Port_Property("radd", 32, hls_in, 4, "ap_none", "in_data", 1),
	Port_Property("cmd", 8, hls_in, 5, "ap_none", "in_data", 1),
	Port_Property("sta", 8, hls_out, 6, "ap_ovld", "out_data", 1),
	Port_Property("sta_ap_vld", 1, hls_out, 6, "ap_ovld", "out_vld", 1),
	Port_Property("AXI", 64, hls_in, 7, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "parallel_to_AXI";
