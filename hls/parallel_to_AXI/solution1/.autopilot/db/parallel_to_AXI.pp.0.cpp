# 1 "parallel_to_AXI/src/parallel_to_AXI.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "parallel_to_AXI/src/parallel_to_AXI.cpp" 2
...
# 2 "parallel_to_AXI/src/parallel_to_AXI.cpp" 2

__attribute__((sdx_kernel("parallel_to_AXI", 0))) void parallel_to_AXI(
ap_uint<32> wdata,
ap_uint<32> wadd,
ap_uint<32> *rdata,
ap_uint<32> radd,
...
{_ssdm_SpecArrayDimSize(AXI, 256);
#pragma HLS INTERFACE ap_none port=radd
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS INTERFACE ap_none port=wadd
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS INTERFACE ap_none port=wdata
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS INTERFACE ap_ovld port=rdata
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS INTERFACE ap_ovld port=sta
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS INTERFACE m_axi depth=1024 port=AXI offset=direct
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS INTERFACE port=cmd
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS PIPELINE enable_flush
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"

#pragma HLS TOP name=parallel_to_AXI
# 12 "parallel_to_AXI/src/parallel_to_AXI.cpp"
