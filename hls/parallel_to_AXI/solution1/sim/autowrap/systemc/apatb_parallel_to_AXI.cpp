...
extern "C" void parallel_to_AXI_hw_stub(__cosim_s1__, __cosim_s1__, volatile void *, __cosim_s1__, __cosim_s1__, volatile void *, volatile void *);

extern "C" void apatb_parallel_to_AXI_hw(__cosim_s1__ __xlx_apatb_param_wdata, __cosim_s1__ __xlx_apatb_param_wadd, volatile void * __xlx_apatb_param_rdata, __cosim_s1__ __xlx_apatb_param_radd, __cosim_s1__ __xlx_apatb_param_cmd, volatile void * __xlx_apatb_param_sta, volatile void * __xlx_apatb_param_AXI) {
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > rdata_pc_buffer(1);
          int i = 0;
          ...
          if (i > 0) {
            ((char*)__xlx_apatb_param_rdata)[0] = rdata_pc_buffer[0].to_int64();
          }
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
// print wdata Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_wdata);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_wdata, __xlx_sprintf_buffer.data()); 
  }
...
// print wadd Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_wadd);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_wadd, __xlx_sprintf_buffer.data()); 
  }
...
// print rdata Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_rdata);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_rdata, __xlx_sprintf_buffer.data()); 
  }
...
// print radd Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_radd);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_radd, __xlx_sprintf_buffer.data()); 
  }
