...
if {[file isfile parallel_to_AXI.autotvin.dat]} {
	file delete -force parallel_to_AXI.autotvin.dat
}

if {[file isfile parallel_to_AXI.autotvout.dat]} {
	file delete -force parallel_to_AXI.autotvout.dat
}
