...
HLS_SOURCES = ../../../src/main.cpp ../../../src/parallel_to_AXI.cpp
...
$(ObjDir)/parallel_to_AXI.o: ../../../src/parallel_to_AXI.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../src/parallel_to_AXI.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/parallel_to_AXI.d
