...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "parallel_to_AXI.autotvin.dat"
	set constFileTvOut       "parallel_to_AXI.autotvout.dat"
	set constFileHdlTvIn     "parallel_to_AXI.autohdltvin.dat"
	set constFileHdlTvOut    "parallel_to_AXI.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
